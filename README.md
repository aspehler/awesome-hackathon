...
- [HackHQ](https://hackhq.io/) - All-in-one hackathon and competition platform with built-in registration, submissions, judging, and real-time results during live events. No account required for participants or judges. Launch events in 30 minutes.
...
- [Odyssey](https://github.com/HackSC/odyssey) - A hackathon management platform, built by HackSC.
